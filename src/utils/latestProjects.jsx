...
export const projects = [
  {
    ...
    desc: 'search gallery',
    url: project1,
    info: 'I developed an Unsplash image application that enables users to search for images using the Unsplash API. The app also includes a dark mode option for theme management. For enhanced security, I employed environment variables for sensitive information. To optimize data retrieval and caching, I utilized React Query and its developer tools for efficient debugging and monitoring.',
  ...
  },
  {
    ...
    url: project2,
    info: 'I developed an E-commerce project focusing on an online furniture store. The project utilizes Auth0 for user authentication. I implemented an advanced filter system, allowing users to conveniently sort products by various criteria such as name, company, color, and price range. The user interface features a column and row layout, enhancing the browsing experience. Additionally, I integrated a sorting feature to help users find products more easily. For secure payment processing, used the Stripe API.',
  ...
  },
  {
    ...
    desc: 'git-app',
    url: project3,
    info: 'I have developed a React.js project that enables visitors to search for GitHub users. The project displays various information about the users, including the number of repositories they have and a list of their followers. I integrated Auth0 for authentication and utilized the Axios library for fetching data. Additionally, I incorporated a chat feature to provide detailed information about the user.',
